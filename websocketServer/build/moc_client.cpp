...
QT_MOC_LITERAL(3, 21, 21) // "binaryMessageReceived"

    },
    "Client\0disconnected\0\0binaryMessageReceived"
};
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Client::binaryMessageReceived)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void Client::binaryMessageReceived(const QByteArray & _t1)
{
